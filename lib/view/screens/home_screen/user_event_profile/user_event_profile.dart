                  ...
                  children: [
                    ...
                    SizedBox(
                     ...
                     CustomTabSelector(
                          ...
                          selectedIndex: eventsController.profile_currentIndex.value,
                          onTabSelected: (value) {
                            eventsController.profile_currentIndex.value = value;
                          },
                    ...
                    if (eventsController.profile_currentIndex.value == 0)
                      Column(
                    ...
                    if(eventsController.profile_currentIndex.value == 1)
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ///========== volunteer =========
